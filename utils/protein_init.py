...
def get_T5_model():
    ...
    # model = T5EncoderModel.from_pretrained(r"/home/zhangzh/UniKP-main/premodel/prot_t5_xl_uniref50").to(device)
    # model = T5EncoderModel.from_pretrained(r"E:\UniKP-main\premodel\prot_t5_xl_uniref50").to(device)
    # model = T5EncoderModel.from_pretrained(r"/workspace/zhangzh/UniKP-main/premodel/prot_t5_xl_uniref50").to(device)
    model = T5EncoderModel.from_pretrained(r"/workspace/zhangzh/UniKP-main/premodel/prot_t5_xl_uniref50_safetensors", use_safetensors=True).to(device)
    ...
    # tokenizer = T5Tokenizer.from_pretrained(r"/home/zhangzh/UniKP-main/premodel/prot_t5_xl_uniref50", do_lower_case=False,force_download=True)
    # tokenizer = T5Tokenizer.from_pretrained(r"E:\UniKP-main\premodel\prot_t5_xl_uniref50", do_lower_case=False,force_download=True)
    tokenizer = T5Tokenizer.from_pretrained(r"/workspace/zhangzh/UniKP-main/premodel/prot_t5_xl_uniref50", do_lower_case=False,force_download=True)
...
class ProteinInit(object):
    def __init__(self):
        ...
        self.model_T5, self.tokenizer_T5 = get_T5_model()
    def protein_init(self,Sequence): #,organism
        result_dict = {}
        seqs = dict()
        for seq in Sequence:
            if len(seq) > 1000:
            ...
            seqs[seq] = seq_re
        results = get_embeddings(self.model_T5, self.tokenizer_T5, seqs, "True", "True")
        ...
        for seq in Sequence:
            ...
            token_repr, contact_map_proba, logits = esm_extract(self.model, self.batch_converter, seq_max, layer=33, approach='last',dim=1280)
